...
function (gtest_discover_tests_impl)
    ...
    cmake_parse_arguments(
        ""
        ""
        "NO_PRETTY_TYPES;NO_PRETTY_VALUES;TEST_EXECUTABLE;TEST_WORKING_DIR;TEST_PREFIX;TEST_SUFFIX;TEST_LIST;CTEST_FILE;TEST_DISCOVERY_TIMEOUT;TEST_XML_OUTPUT_DIR;TEST_FILTER;TEST_MPI_EXEC_COMMAND"
            ...
            if (NOT line MATCHES "^  ")
                ...
                if (NOT "${_TEST_XML_OUTPUT_DIR}" STREQUAL "")
                    set(TEST_XML_OUTPUT_PARAM
                        "--gtest_output=xml:${_TEST_XML_OUTPUT_DIR}/${prefix}${suite}.${test}${suffix}.xml"
                    )
                else ()
                ...
                # ...and add to script
                set(MPI_ARGS ${TEST_MPI_EXEC_COMMAND})
                separate_arguments(MPI_ARGS)
                add_command(
                    add_test
                    "${testname}"
                    ${MPI_ARGS}
                ...
                if (suite MATCHES "^DISABLED_" OR test MATCHES "^DISABLED_")
                    add_command(set_tests_properties "${testname}" PROPERTIES DISABLED TRUE)
                endif ()
                add_command(
